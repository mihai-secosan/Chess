...
namespace ChessGame
{
    public class Queen : APiece
    {
        ...
        //public Pieces type = Pieces.Queen;
        ...
        public override Bitmap GetImage()
        {
            if (bufferedImage == null)
            {
                ...
                if (Color == PieceColors.White)
                {
                    ...
                    Rectangle sourceRectangle = new Rectangle(0, 60, 60, 60); // Regina alba //
                ...
                {
                    Rectangle destinationRectangle = new Rectangle(0, 0, 60, 60);
                    Rectangle sourceRectangle = new Rectangle(0, 0, 60, 60); // Regina neagra //
